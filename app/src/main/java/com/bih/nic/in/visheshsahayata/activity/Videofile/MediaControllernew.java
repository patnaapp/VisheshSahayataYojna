package com.bih.nic.in.visheshsahayata.activity.Videofile;
...
import com.bih.nic.in.visheshsahayata.activity.Config;
...
public class MediaControllernew {
    ...
    private static volatile MediaControllernew Instance = null;
    private boolean videoConvertFirstWrite = true;
    static Context context;



    public static MediaControllernew getInstance() {
        MediaControllernew localInstance = Instance;
        if (localInstance == null) {
            synchronized (MediaControllernew.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new MediaControllernew();
                }
            }
        }
    ...
    public static class VideoConvertRunnable implements Runnable {
        ...
        @Override
        public void run() {
            MediaControllernew.getInstance().convertVideo(videoPath,context);
        }
    }
    ...
    @TargetApi(16)
    public boolean convertVideo(final String path,Context _context) {
...
//          retriever.setDataSource(input.getFD());
          ...
          PreferenceManager.getDefaultSharedPreferences(_context).edit().putString("TIMESTAMP", timestamp).commit();
